...
const NAV_LINKS = [
  {
    to: "/", label: "功能讲解", icon: <svg xmlns="http://www.w3.org/2000/svg" width="1.4em" height="1.4em" viewBox="0 0 24 24">
  ...
  {
    to: "/status", label: "状态设置", icon: <svg xmlns="http://www.w3.org/2000/svg" width="1.4em" height="1.4em" viewBox="0 0 24 24">
      <path d="M0 0h24v24H0z" fill="none" />
  ...
  {
    to: "/history", label: "自动存档", icon: <svg xmlns="http://www.w3.org/2000/svg" width="1.4em" height="1.4em" viewBox="0 0 24 24">
      <path d="M0 0h24v24H0z" fill="none" />
  ...
  {
    to: "/manual", label: "手动存档", icon: <svg xmlns="http://www.w3.org/2000/svg" width="1.4em" height="1.4em" viewBox="0 0 24 24">
      <path d="M0 0h24v24H0z" fill="none" />
  ...
  {
    to: "/about", label: "插件说明", icon: <svg xmlns="http://www.w3.org/2000/svg" width="1.4em" height="1.4em" viewBox="0 0 24 24">
      <path d="M0 0h24v24H0z" fill="none" />
